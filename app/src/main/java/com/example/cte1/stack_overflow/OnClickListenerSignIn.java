...
import static com.example.cte1.stack_overflow.MainActivity.*;
...
//                        }
    ...
    class ConnectionTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            myMethod(formTextId, formTextPwd1, formTextAddr);
            return "";
        }
